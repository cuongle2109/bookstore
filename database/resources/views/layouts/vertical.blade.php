...
<script>
    ...
    $(document).ready(function () {
        ...
        function setHtmlShoppingCart(data) {
            ...
            htmlHeader = `<li class="block-view-cart__list-group__list-group-item">(<span class="totalQuantityCart">${getTotalQuantityCart(cartSession)}</span>) Items from Barnes & Noble</li>`
                        ...
                        <div class="row">
                            ...
                            <div class="col-5">
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label">Ship this item</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" disabled>
                                    <label class="form-check-label">Buy Online, Pick up in Store</label>
                                </div>
                                <div class="remove-item">
                                    <a href="" class="remove-item-cart" data-id="${val.id}">Remove</a>
                                </div>
                            </div>
                            <div class="col-5">
        ...
        function setHtmlCompareProductSecond(product) {
            ...
            htmlLinkRedirect = `<a href="./${product.id}">Go to product ${product.name}</a>`
