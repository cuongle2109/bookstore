            ...
            <div class="row mt-3">
                ...
                <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
                    ...
                    <h6 class="text-uppercase fw-bold mb-4">
                        <svg width="248" height="22" xmlns="http://www.w3.org/2000/svg"
                             xmlns:xlink="http://www.w3.org/1999/xlink" alt="logo" class="brand rhf-logo mobile-hide">
                            <defs>
                            ...
                            <g fill="none" fill-rule="evenodd">
                                ...
                                <g transform="translate(233.816 1.788)">
                                    <mask id="d" fill="#3e5962">
                                        <use xlink:href="#c"></use>
                                    </mask>
                                    <path fill="#3e5962" mask="url(#d)"
                                          d="M.057.145h13.166V3.56h-9.35v3.54H12.1v3.417H3.873v3.666h9.475V17.6H.058z"></path>
                                </g>
                            </g>
                        </svg>
