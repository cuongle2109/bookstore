    ...
    <div class="block-profile">
        <div class="container mt-5 mb-5">
            <div class="row">
                ...
                <div class="col-10">
                    <form method="post" action="{{ route('mypage.change-password.update', $user->id) }}">
                        @csrf
                        @method('PUT')
                        <div class="box-shadow">
                            <h3>Đổi mật khẩu</h3>
                            <p>Để cập nhật mật khẩu mới, vui lòng xác nhận bằng cách nhập mật khẩu</p>
                            <hr>
                            ...
                            <div class="row g-3 align-items-center mb-3">
                                ...
                                <div class="col-5">
                                    <input type="password" class="form-control {{$errors->has('OldPassword') ? 'is-invalid' : ''}}" name="OldPassword">
                                    @if($errors->has('OldPassword'))
                                        <div class="invalid-feedback">
                                            @foreach ($errors->getMessages()['OldPassword'] as $error)
                                                <div>{{$error}}</div>
                                            @endforeach
                                        </div>
                                    @endif
